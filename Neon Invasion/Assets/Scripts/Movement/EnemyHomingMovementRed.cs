...
public class EnemyHomingMovementRed : MonoBehaviour
{
    [SerializeField]
    ...
    {
        if (collision.gameObject.CompareTag("RedBullet") && !hasEntered)
        {
            hasEntered = true;
    ...
    {
        if (collision.gameObject.CompareTag("RedBullet") && hasEntered == true)
        {
            hasEntered = false;
        }
    }
